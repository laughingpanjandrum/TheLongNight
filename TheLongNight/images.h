...
const imageSharedPtr IMAGE_DRAGONBONE_SHIELD = loadWeaponImage("S_dragonbone_shield");
const imageSharedPtr IMAGE_ETHEREAL_SHIELD = loadWeaponImage("S_ethereal shield");
const imageSharedPtr IMAGE_GREEN_KNIGHTS_SHIELD = loadWeaponImage("S_green knight shield");
...
const imageSharedPtr IMAGE_BLOODY_GREATAXE = loadWeaponImage("W_bloody greataxe");
const imageSharedPtr IMAGE_CRIMSON_NAIL = loadWeaponImage("W_crimson nail");
...
const imageSharedPtr IMAGE_DRAGONBONE_SWORD = loadWeaponImage("W_dragonbone sword");
const imageSharedPtr IMAGE_ENERGY_SWORD = loadWeaponImage("W_energy sword");
...
const imageSharedPtr IMAGE_GREEN_KNIGHT_SWORD = loadWeaponImage("W_green knight sword");
...
const imageSharedPtr IMAGE_LIGHTNING_WARHAMMER = loadWeaponImage("W_lightning warhammer");
...
const imageSharedPtr IMAGE_POISONOUS_CLAWS = loadWeaponImage("W_poisonous claws");
const imageSharedPtr IMAGE_PROFANE_GREATSWORD = loadWeaponImage("W_profane greatsword");
const imageSharedPtr IMAGE_PROFANE_SCYTHE = loadWeaponImage("W_iteras scythe");
const imageSharedPtr IMAGE_SACRIFICAL_KNIFE = loadWeaponImage("W_sacrificial knife");
const imageSharedPtr IMAGE_SENTINEL_SPEAR = loadWeaponImage("W_sentinelspear");
const imageSharedPtr IMAGE_SERPENTS_TOOTH = loadWeaponImage("W_serpent tooth");
const imageSharedPtr IMAGE_SLAVEMASTER_WHIP = loadWeaponImage("W_slave master whip");
const imageSharedPtr IMAGE_SPIDERBONE_SHARD = loadWeaponImage("W_spiderbone shard");
...
const imageSharedPtr IMAGE_SUPER_HOLY_SCYTHE = loadWeaponImage("W_super holy scythe");
...
const imageSharedPtr IMAGE_VOIDFIRE_KNIFE = loadWeaponImage("W_voidfire knife");
