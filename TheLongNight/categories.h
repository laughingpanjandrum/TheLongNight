...
enum gameState {
	STATE_VIEW_MAP, STATE_VIEW_WORLD_MAP,
...
{ ITEM_WEAPON, ITEM_OFFHAND, ITEM_BODY_ARMOUR, ITEM_HELMET, ITEM_CHARM, ITEM_CONSUMABLE, ITEM_SPELL, ITEM_MISC, ITEM_KEY };
...
enum effect {
	...
	NAVIGATE_STAIRS, MAKE_RITUAL_OFFERING, WARP_TO_SAVE_POINT,
	//Nice effects
	...
	TEMP_GAIN_DEFENCE, TEMP_GAIN_ELEMENTAL_DEFENCE,
	//Damage effects
	...
	DROP_OOZE, DROP_WEB, DROP_DRAINING_POOL, DROP_CORRODING_BLOOD, CREATE_FOG,
	GAIN_HEALTH_ON_KILL, BECOME_INVISIBLE, 
	BLEED_DAMAGE_FACTOR, HEALING_FACTOR,
	APPLY_DAMAGE_PENALTY, GAIN_DAMAGE_BUFF, GAIN_DIVINE_RETRIBUTION,
	INSTILL_FEAR, GAIN_KILL_DAMAGE_BUFF,
	DAMAGE_WHEN_POISONED, BUFF_HOLY_DAMAGE,
	DEATHFIRE_INFUSION, DEATHLINK, SILENCE,
	ASTRAL_IMPRISONMENT, MOON_GATE_WARP,
	ACQUIRE_FRAGMENTS,
	//Elemental damage buffs
	SCALE_ACID_DAMAGE, SCALE_COLD_DAMAGE, SCALE_ELECTRIC_DAMAGE, SCALE_FIRE_DAMAGE,
};
